...
package body MyStringTokeniser with SPARK_Mode is
   ...
   begin
      ...
      -- OutIndex: still have space in tokenarray
      -- Index : string not yet finished
      -- Processed: The #of tokens within token's length
      while OutIndex <= Tokens'Last and Index <= S'Last and Processed < Tokens'Length loop
         ...
         -- Task1 Addcommentstomystringtokeniser.adb thatexplaintheloopinvariantfortheTokenise
